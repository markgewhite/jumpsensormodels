    ...
    switch i
        ...
        case 10
            ...
            parameters = [ "data.args.SignalType", ...
                           ...
                           "model.args.ModelType"];
            values = { {'AnteroposteriorAcc', 'LateralAcc', 'VerticalAcc', ...
                             'ResultantAcc', ...
                             'ResultantGyro', 'ResultantAccGyro'}, ...
                       {false, true}, ...
                       {'Linear', 'Ridge', 'Lasso', 'SVM', 'XGBoost'} };
        ...
        case 12
            ...
            parameters = [ "data.args.SignalType", ...
                           "data.args.SignalAligned", ...
                           "model.args.ContinuousEncodingArgs.AlignmentMethod"];
            values = { {'LateralAcc', 'VerticalAcc', 'AnteroposteriorAcc', ...
                             'ResultantAcc', '2DAcc', '3DAcc', ...
                             'ResultantGyro', 'ResultantAccGyro', '6D'}, ...
                       {false, true}, ...
                       {'XCMeanConv', 'XCRandom', 'LMTakeoff', 'LMLanding', ...
                        'LMTakeoffDiscrete'} };
