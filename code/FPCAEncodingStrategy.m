            ...
            arguments
                ...
                args.AlignmentMethod    char ...
                    {mustBeMember( args.AlignmentMethod, ...
                        {'XCRandom', 'XCMeanConv', ...
                         'LMTakeoffPeak', 'LMLandingPeak', ...
                         'LMTakeoffBiomechanical', ...
                         'LMTakeoffActual', ...
                         'LMTakeoffPeakCorrection' })} = 'LMTakeoffPeak'
    ...
    methods (Access = private)
        ...
        function XAligned = setCurveAlignment( self, thisDataset )
            ...
            switch self.AlignmentMethod
                ...
                case {'LMTakeoffPeak', 'LMLandingPeak', ...
                        'LMTakeoffBiomechanical', 'LMTakeoffActual', 'LMTakeoffPeakCorrection'}
        ...
        function offset = findLandmark( self, X, refIdx )
            ...
            switch self.AlignmentMethod
                case {'LMTakeoffPeak', 'LMLandingPeak', 'LMTakeoffPeakCorrection'}
                    offset = findLandmarkStandard( X, ...
                                                   self.AlignmentMethod, ...
                                                   self.SamplingFreq );
                case 'LMTakeoffBiomechanical'
